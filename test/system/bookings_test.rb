...
class BookingsTest < ApplicationSystemTestCase
  ...
  test "should create booking" do
    ...
    check "Confirmed" if @booking.confirmed
    fill_in "End date", with: @booking.end_date
    fill_in "Full name", with: @booking.full_name
    fill_in "Housekeeper", with: @booking.housekeeper_id
    fill_in "Pet description", with: @booking.pet_description
    fill_in "Price", with: @booking.price
    fill_in "Review", with: @booking.review
